...
## Environments
- Preview: https://main--subrat-seminole-analysis--aemysites.aem.page/
- Live: https://main--subrat-seminole-analysis--aemysites.aem.live/
- Block Library: https://main--subrat-seminole-analysis--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `subrat-seminole-analysis` directory in your favorite IDE and start coding :)
